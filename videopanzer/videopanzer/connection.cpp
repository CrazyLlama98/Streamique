...
bool Connection::sendMessage(const QString &message) {
    ...
    QNetworkRequest reqMessage(QUrl("http://streamique.azurewebsites.net/ /api/lobbies/{lobbyId}/Messages"));
    reqMessage.setRawHeader("Authorization", QString("Bearer " + peermanager::token).toUtf8());

    QJsonDocument jsonMessage(message);

    NAM.post(reqMessage, jsonMessage.toBinaryData());
